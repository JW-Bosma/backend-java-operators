public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("three_point_5 : " + three_point_5);
        System.out.println("one_point_5 : " + one_point_5);
